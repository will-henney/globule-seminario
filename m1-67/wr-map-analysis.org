...
This shows a clear net displacement in dx of about -0.06 arcsec, which must be an alignment problem between hst and jwst. Apart from that, everything looks approximately flat. Not much evidence of proper motion, but we will see with the radii
...
- Proper motion measurements from Marchenko:2010a are based on the outer parts of the nebula and correspond to Δr = 0.0326 ± 0.0059 arcsec over Δt = 11.26 yr
