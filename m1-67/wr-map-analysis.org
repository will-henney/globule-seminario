...
** Run the find-knot-cores.py script for different images
#+begin_src sh :dir data/reproject :results verbatim
...
#+begin_src sh :dir data/reproject :results verbatim
  python ../../scripts/compare-knot-positions.py wr124-hst-1997-f656n-radec wr124-hst-2008-f656n-radec 
#+end_src
...
#+begin_src sh :dir data/reproject :results verbatim
  python ../../scripts/compare-knot-positions.py wr124-hst-2008-f656n-radec combo-E-ionized
#+end_src
