...
#+begin_src sh :dir data/reproject :results verbatim
  python ../../scripts/find-knot-sizes.py \
         combo-D-neutral.fits --mask-radius-arcsec 0.2
#+end_src
...
: Saved peak regions to combo-D-neutral-knot-peak-sizes.reg
...
: Saved peak regions to combo-AA-neutral-knot-peak-sizes.reg
...
: Saved peak regions to combo-DD-neutral-knot-peak-sizes.reg
...
: Saved peak regions to combo-E-ionized-knot-peak-sizes.reg
