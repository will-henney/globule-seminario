...
#+begin_src sh :dir data/jwst-miri-mrs :results ouutput
  python ../../scripts/median_continuum.py 21 wr124-miri-mrs-ch1_s3d.fits --no-two-pass --shave-threshold 1
#+end_src
...
Apply this to the "cont" output of the N=21 filter
...
#+begin_src sh :dir data/jwst-miri-mrs :results output verbatim
  python ../../scripts/median_continuum.py 151 wr124-miri-mrs-ch1_s3d-median-cont-021.fits --no-two-pass --percentile 10
#+end_src
...
And N=1501, which is half the range
#+begin_src sh :dir data/jwst-miri-mrs :results output verbatim
  python ../../scripts/median_continuum.py 1501 wr124-miri-mrs-ch1_s3d.fits --no-two-pass --percentile 20
#+end_src
...
|  3 |        |  14.8163 | He I  ?       | 14.80408269 |    85 | V. diffuse       | 247. |
...
|  3 | f1800w |  16.6038 | UIL           |      16.595 |    30 | Diffuse          | 159. |
...
**** Test readimg the table
  ...
  ...    ...     ...           ...        ...   ...            ...   ...
    3 f1800w 17.8963       [P III]    17.8846   230        Diffuse 196.0
