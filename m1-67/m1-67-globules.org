...
#+begin_src sh :dir data :results file
  python ../scripts/plot-offsets.py wr124-hst-1997-f675w-TO-gaia-OFFSETS.ecsv --max-sep 100
#+end_src
...
#+begin_src sh :dir data :results file
  python ../scripts/plot-offsets.py wr124-hst-1997-f656n-TO-gaia-OFFSETS.ecsv --max-sep 100
#+end_src
...
- This seems to work very well.  All the fits look more credible now. In ann cases except f150w the changes were very small
- 
***** TODO Calculate the correction terms and apply them
- We now write out the shifts and linear correction matrix to a yaml file
...
#+RESULTS:
#+begin_example
Matrix: [[ 9.99986088e-01 -2.23834349e-04]
 [ 3.14915814e-04  1.00005617e+00]]
SCI
WCS Keywords
...
#+RESULTS:
#+begin_example
Matrix: [[ 1.00014408e+00 -3.63201740e-04]
 [ 4.16101236e-04  9.99937065e-01]]
SCI
WCS Keywords
