...
#+begin_src sh :dir data :results file
  python ../scripts/plot-offsets-corr.py wr124-jwst-2022-f090w-TO-gaia-OFFSETS.ecsv --max-sep 100
#+end_src
...
#+begin_src sh :dir data :results file
  python ../scripts/plot-offsets-corr.py wr124-jwst-2022-f150w-TO-gaia-OFFSETS.ecsv --max-sep 100 --alpha 0.3
#+end_src
