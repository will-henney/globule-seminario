...
:PROPERTIES:
:ID:       E6DB5862-941F-494F-883C-7A72C9894BDC
:END:
...
**** MIRI Imaging
:PROPERTIES:
:ID:       8ABE921C-EF8A-443A-8C7D-EEBF4AA6A923
:END:
***** Summary table from Spitzer spectra
:PROPERTIES:
:ID:       BAFF43C0-68C4-47A1-9407-D85507D04941
:END:
...
:PROPERTIES:
:ID:       270E26FA-B168-4712-9A28-8C028C2AE4DF
:END:
...
:PROPERTIES:
:ID:       7BA17133-6976-4A86-BF36-D8F8CAAD3587
:END:
- f1800w / f1280w
...
:PROPERTIES:
:ID:       D33313A5-52A2-412F-B2AE-BE76DB57CB6E
:END:
- f770w
  - 6.5 - 8.7 (W = 2.2)
...
- So I want a quantitative measure of the alignmenteeeeeeeeee
...
#+RESULTS:
[[file:/Users/will/Dropbox/globule-seminario/m1-67/data/jwst-miri-mrs]]

- *UPDATE* [2024-05-26 Sun] This script is not working any more, and the figure file is not there
  - Except that there is this [[file:data/jwst-miri-mrs/jwst-miri-mrs-spec-ORIG.pdf]]
...
| Ch |   wav0 |  d wav |   d V |     R |
|----+--------+--------+-------+-------|
|  1 |    4.9 | 0.0008 |  49.0 | 6125. |
|  2 |  7.511 | 0.0013 |  51.9 | 5778. |
|  3 | 11.551 | 0.0025 |  64.9 | 4620. |
|  4 |   17.7 |  0.006 | 101.7 | 2950. |
#+TBLFM: $4=3e5 $3/$2;f1::$5=$2/$3;f0
...
Now do N=501 for the original cubes
#+begin_src sh :dir data/jwst-miri-mrs :results output verbatim
  for i in 1 2 3; do
      time python ../../scripts/median_continuum.py 501 \
             wr124-miri-mrs-ch${i}_s3d.fits --no-two-pass --percentile 20
  done
  for i in 4; do
      time python ../../scripts/median_continuum.py 251 \
             wr124-miri-mrs-ch${i}_s3d.fits --no-two-pass --percentile 20
...
#+RESULTS:
#+begin_example
Saving median filtered cube to wr124-miri-mrs-ch1_s3d-median-cont-0501.fits
Saving residual cube to wr124-miri-mrs-ch1_s3d-median-csub-0501.fits
Saving ratio cube to wr124-miri-mrs-ch1_s3d-median-cdiv-0501.fits
Saving median filtered cube to wr124-miri-mrs-ch2_s3d-median-cont-0501.fits
Saving residual cube to wr124-miri-mrs-ch2_s3d-median-csub-0501.fits
Saving ratio cube to wr124-miri-mrs-ch2_s3d-median-cdiv-0501.fits
Saving median filtered cube to wr124-miri-mrs-ch3_s3d-median-cont-0501.fits
Saving residual cube to wr124-miri-mrs-ch3_s3d-median-csub-0501.fits
Saving ratio cube to wr124-miri-mrs-ch3_s3d-median-cdiv-0501.fits
Saving median filtered cube to wr124-miri-mrs-ch4_s3d-median-cont-0251.fits
Saving residual cube to wr124-miri-mrs-ch4_s3d-median-csub-0251.fits
Saving ratio cube to wr124-miri-mrs-ch4_s3d-median-cdiv-0251.fits
#+end_example

And for the stellar spectrum cubes
#+begin_src sh :dir data/jwst-miri-mrs :results output verbatim
  for i in 1 2 3; do
      time python ../../scripts/median_continuum.py 501 \
             wr124-miri-mrs-ch${i}-star.fits --no-two-pass --percentile 20
  done
  for i in 4; do
      time python ../../scripts/median_continuum.py 251 \
             wr124-miri-mrs-ch${i}-star.fits --no-two-pass --percentile 20
...
#+RESULTS:
#+begin_example
Saving median filtered cube to wr124-miri-mrs-ch1-star-median-cont-0501.fits
Saving residual cube to wr124-miri-mrs-ch1-star-median-csub-0501.fits
Saving ratio cube to wr124-miri-mrs-ch1-star-median-cdiv-0501.fits
Saving median filtered cube to wr124-miri-mrs-ch2-star-median-cont-0501.fits
Saving residual cube to wr124-miri-mrs-ch2-star-median-csub-0501.fits
Saving ratio cube to wr124-miri-mrs-ch2-star-median-cdiv-0501.fits
Saving median filtered cube to wr124-miri-mrs-ch3-star-median-cont-0501.fits
Saving residual cube to wr124-miri-mrs-ch3-star-median-csub-0501.fits
Saving ratio cube to wr124-miri-mrs-ch3-star-median-cdiv-0501.fits
Saving median filtered cube to wr124-miri-mrs-ch4-star-median-cont-0251.fits
Saving residual cube to wr124-miri-mrs-ch4-star-median-csub-0251.fits
Saving ratio cube to wr124-miri-mrs-ch4-star-median-cdiv-0251.fits
#+end_example
...
#+begin_src sh :dir data/jwst-miri-mrs :results silent
  python ../../scripts/make-line-maps.py wr124-miri-mrs-ch1-nostar-median-csub-0501-med2pass-csub-0021.fits
  python ../../scripts/make-line-maps.py wr124-miri-mrs-ch2-nostar-median-csub-0501-med2pass-csub-0021.fits
  python ../../scripts/make-line-maps.py wr124-miri-mrs-ch3-nostar-median-csub-0501-med2pass-csub-0021.fits
  python ../../scripts/make-line-maps.py wr124-miri-mrs-ch4-nostar-median-csub-0251-med2pass-csub-0011.fits
#+end_src
...
- Currently I am just summing the pixels, but that does not seem right
- The brightness units are ~MJy/sr~, which is ~1e-17 erg /cm^2 /s /Hz /sr~
- One strategy would be to convert to F_\lambda and then integrate in wavelength, but that gives something that is not readily comparable with the original brightness maps
- Alternatively, we just integrate F_\nu with wavelength, so the units are ~micron MJy/sr~
  - So we just need to multiply by the d\lambda in microns
- This has the advantage that we can compare with the continuum brightness multiplied by the filter width
- And that the EW is just the sum divided by the continuum
- We can apply exactly the same thing to the AIB bands
- But for the continuum bands, it would be better to do the mean brightness and keep it in MJy/sr
...
- [2023-11-22 Wed] *Conclusion*
  - Decided to go with combination of options 2 and 3
    - PSF fitting to remove stellar contribution
    - High-pass Median filter R \approx 12 (N=501) to remove the continuum
    - Low-pass Median filter R \approx 300, dV \approx 1000 km/s (N=21) to remove the emission lines
    - Then just integrate across the band
...
*** Make maps of the continuum bands
...
**** Table of continuum bands
:PROPERTIES:
:TABLE_EXPORT_FILE: data/jwst-miri-mrs/jwst-miri-cont-bands.tab
:TABLE_EXPORT_FORMAT: orgtbl-to-tsv
:END:

#+name: jwst-miri-cont-bands
| Ch | Band      | wavmin | wavmax |
|----+-----------+--------+--------|
|  1 | CONT 6.2  |    6.0 |    6.5 |
|  1 | CONT 7.5  |   7.55 |   7.65 |
|  2 | CONT 8.5  |   7.52 |    9.5 |
|  2 | CONT 11.0 |   10.3 |   11.7 |
|  3 | CONT 12.8 |   11.6 |   14.0 |
|  3 | CONT 15.0 |   14.0 |   16.0 |
|  3 | CONT 17.0 |   16.0 |   17.9 |
|  4 | CONT 19.0 |   18.0 |   20.0 |
|  4 | CONT 22.0 |   20.0 |   24.0 |
|  4 | CONT 25.5 |   24.0 |   27.0 |
- Save table with ~C-c t e~
- The bands are chosen to be close to PAH bands
- Many bands are badly affected by the stellar subtraction
- Also to approximately coincide with MIRI filters, where possible:
  - f777w: CONT 7.0 (ch01) + CONT 8.5 (ch02)
  - f1130w: CONT 11.0 (ch02)
  - f1280w: CONT 12.8 (ch03)
  - f1800w: CONT 17.0 (ch03) + CONT 19.0 (ch04)
**** Run the script to extract the continuum maps
- Similar to the AIB bands but with some differences
  - We use the ~--use-mean~ option to get mean MJy/sr in each band
  - We use the broad low-pass filtered cubes

#+begin_src sh :dir data/jwst-miri-mrs :results silent
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch1-nostar-median-cont-0501.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps --use-mean
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch2-nostar-median-cont-0501.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps --use-mean
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch3-nostar-median-cont-0501.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps --use-mean
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch4-nostar-median-cont-0251.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps --use-mean
#+end_src

Repeat for the original cubes that have not had the star removed

#+begin_src sh :dir data/jwst-miri-mrs :results silent
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch1_s3d-median-cont-0501.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps-plus-star --use-mean
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch2_s3d-median-cont-0501.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps-plus-star --use-mean
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch3_s3d-median-cont-0501.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps-plus-star --use-mean
  python ../../scripts/make-band-maps.py wr124-miri-mrs-ch4_s3d-median-cont-0251.fits --band-table-path jwst-miri-cont-bands.tab --out-path ContMaps-plus-star --use-mean
#+end_src
...
**** First make maps of the original cubes
F770W straddles channels 1 and 2, so we need to take the average of them both
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  python ../../scripts/make-filter-map.py f770w wr124-miri-mrs-ch1_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.374061 at 7.479 micron
: Writing filter image to FilterMaps/wr124-miri-mrs-ch1_s3d-f770w.fits

#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  python ../../scripts/make-filter-map.py f770w wr124-miri-mrs-ch2_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.382959 at 8.081 micron
: Writing filter image to FilterMaps/wr124-miri-mrs-ch2_s3d-f770w.fits

F1130W is almost fully in channel 2
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
    python ../../scripts/make-filter-map.py f1130w wr124-miri-mrs-ch2_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.465154 at 11.481 micron
: Writing filter image to FilterMaps/wr124-miri-mrs-ch2_s3d-f1130w.fits

With a little tiny bit in channel 3, which we should probably discount
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
    python ../../scripts/make-filter-map.py f1130w wr124-miri-mrs-ch3_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.446836 at 11.551 micron
: Writing filter image to FilterMaps/wr124-miri-mrs-ch3_s3d-f1130w.fits

F1280W is almost fully in channel 3
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
    python ../../scripts/make-filter-map.py f1280w wr124-miri-mrs-ch3_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.406826 at 12.084 micron
: Writing filter image to /Users/will/Dropbox/globule-seminario/m1-67/data/jwst-miri-mrs/FilterMaps/wr124-miri-mrs-ch3_s3d-f1280w.fits

F1800W straddles channel 3 and 4
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
    python ../../scripts/make-filter-map.py f1800w wr124-miri-mrs-ch3_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.473396 at 17.399 micron
: Writing filter image to FilterMaps/wr124-miri-mrs-ch3_s3d-f1800w.fits

#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
    python ../../scripts/make-filter-map.py f1800w wr124-miri-mrs-ch4_s3d.fits 
#+end_src

#+RESULTS:
: Maximum throughput: 0.468658 at 17.703 micron
: Writing filter image to FilterMaps/wr124-miri-mrs-ch4_s3d-f1800w.fits


**** Repeat the filter maps for the star-subtracted cubes
- It is noticeable that the f1800w-ch4 map is brighter than the f1800w-ch3 map, which makes sense since the spectrum is rising with wavelength
  - Unlike 

#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  prefix=wr124-miri-mrs
  suffix=nostar
  outprefix=nostar-all
  cmd="python ../../scripts/make-filter-map.py"
  for i in f770w,1 f770w,2 f1130w,2 f1280w,3 f1800w,3 f1800w,4; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
#+end_src
...
#+begin_example
Maximum throughput: 0.374061 at 7.479 micron
Writing filter image to FilterMaps/nostar-all-f770w-ch1.fits
Maximum throughput: 0.382959 at 8.081 micron
Writing filter image to FilterMaps/nostar-all-f770w-ch2.fits
Maximum throughput: 0.465154 at 11.481 micron
Writing filter image to FilterMaps/nostar-all-f1130w-ch2.fits
Maximum throughput: 0.406826 at 12.084 micron
Writing filter image to FilterMaps/nostar-all-f1280w-ch3.fits
Maximum throughput: 0.473396 at 17.399 micron
Writing filter image to FilterMaps/nostar-all-f1800w-ch3.fits
Maximum throughput: 0.468658 at 17.703 micron
Writing filter image to FilterMaps/nostar-all-f1800w-ch4.fits
#+end_example

**** And for the different components
- It is annoying that channel 4 is different


***** Continuum
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  prefix=wr124-miri-mrs
  suffix=nostar-median-cont-0501
  outprefix=nostar-cont
  cmd="python ../../scripts/make-filter-map.py"
  for i in f770w,1 f770w,2 f1130w,2 f1280w,3 f1800w,3; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
  suffix=nostar-median-cont-0251
  for i in f1800w,4; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
#+end_src
...
#+begin_example
Maximum throughput: 0.374061 at 7.479 micron
Writing filter image to FilterMaps/nostar-cont-f770w-ch1.fits
Maximum throughput: 0.382959 at 8.081 micron
Writing filter image to FilterMaps/nostar-cont-f770w-ch2.fits
Maximum throughput: 0.465154 at 11.481 micron
Writing filter image to FilterMaps/nostar-cont-f1130w-ch2.fits
Maximum throughput: 0.406826 at 12.084 micron
Writing filter image to FilterMaps/nostar-cont-f1280w-ch3.fits
Maximum throughput: 0.473396 at 17.399 micron
Writing filter image to FilterMaps/nostar-cont-f1800w-ch3.fits
Maximum throughput: 0.468658 at 17.703 micron
Writing filter image to FilterMaps/nostar-cont-f1800w-ch4.fits
#+end_example

***** Narrow lines
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  prefix=wr124-miri-mrs
  suffix=nostar-median-csub-0501-med2pass-csub-0021
  outprefix=nostar-lines
  cmd="python ../../scripts/make-filter-map.py"
  for i in f770w,1 f770w,2 f1130w,2 f1280w,3 f1800w,3; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
  suffix=nostar-median-csub-0251-med2pass-csub-0011
  for i in f1800w,4; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
...
#+begin_example
Maximum throughput: 0.374061 at 7.479 micron
Writing filter image to FilterMaps/nostar-lines-f770w-ch1.fits
Maximum throughput: 0.382959 at 8.081 micron
Writing filter image to FilterMaps/nostar-lines-f770w-ch2.fits
Maximum throughput: 0.465154 at 11.481 micron
Writing filter image to FilterMaps/nostar-lines-f1130w-ch2.fits
Maximum throughput: 0.406826 at 12.084 micron
Writing filter image to FilterMaps/nostar-lines-f1280w-ch3.fits
Maximum throughput: 0.473396 at 17.399 micron
Writing filter image to FilterMaps/nostar-lines-f1800w-ch3.fits
Maximum throughput: 0.468658 at 17.703 micron
Writing filter image to FilterMaps/nostar-lines-f1800w-ch4.fits
#+end_example

***** AIB bands
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  prefix=wr124-miri-mrs
  suffix=nostar-median-csub-0501-med2pass-cont-0021
  outprefix=nostar-bands
  cmd="python ../../scripts/make-filter-map.py"
  for i in f770w,1 f770w,2 f1130w,2 f1280w,3 f1800w,3; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
  suffix=nostar-median-csub-0251-med2pass-cont-0011
  for i in f1800w,4; do
      IFS=',' read fn chan <<< "${i}"
      ${cmd} ${fn} ${prefix}-ch${chan}-${suffix}.fits --out-prefix ${outprefix}-${fn}-ch${chan}
  done
...
#+begin_example
Maximum throughput: 0.374061 at 7.479 micron
Writing filter image to FilterMaps/nostar-bands-f770w-ch1.fits
Maximum throughput: 0.382959 at 8.081 micron
Writing filter image to FilterMaps/nostar-bands-f770w-ch2.fits
Maximum throughput: 0.465154 at 11.481 micron
Writing filter image to FilterMaps/nostar-bands-f1130w-ch2.fits
Maximum throughput: 0.406826 at 12.084 micron
Writing filter image to FilterMaps/nostar-bands-f1280w-ch3.fits
Maximum throughput: 0.473396 at 17.399 micron
Writing filter image to FilterMaps/nostar-bands-f1800w-ch3.fits
Maximum throughput: 0.468658 at 17.703 micron
Writing filter image to FilterMaps/nostar-bands-f1800w-ch4.fits
#+end_example

**** And for the star only
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  prefix=wr124-miri-mrs
  suffix=star
  outprefix=star-all
...
#+begin_example
Maximum throughput: 0.374061 at 7.479 micron
Writing filter image to FilterMaps/star-all-f770w-ch1.fits
Maximum throughput: 0.382959 at 8.081 micron
Writing filter image to FilterMaps/star-all-f770w-ch2.fits
Maximum throughput: 0.465154 at 11.481 micron
Writing filter image to FilterMaps/star-all-f1130w-ch2.fits
Maximum throughput: 0.406826 at 12.084 micron
Writing filter image to FilterMaps/star-all-f1280w-ch3.fits
Maximum throughput: 0.473396 at 17.399 micron
Writing filter image to FilterMaps/star-all-f1800w-ch3.fits
Maximum throughput: 0.468658 at 17.703 micron
Writing filter image to FilterMaps/star-all-f1800w-ch4.fits
#+end_example

*** TODO Reproject synthesised filters and combine channels
- In order to do ratios, we need to put the filters on the same grid
- Also, we need to combine the information from adjacent channels in the case of f1800w and f777w
- 
*** Ratios of synthesised filters
- We can re-use the same script that we used for the real filter maps
#+begin_src sh :dir data/jwst-miri-mrs/FilterMaps :results silent
  python ../../../scripts/find-ratio.py \
         wr124-jwst-nircam-2022-f150w-radec.fits \
         wr124-hst-1997-f675w-radec.fits \
         ratio-f150w-f675w.fits \
...
*** DONE Contribution fractions of the synthetic filter maps
CLOSED: [2023-11-27 Mon 13:22]
- Write a script ~filter-fractions.py~
- Display the results in a notebook


**** Calculate fractions
#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  python ../../scripts/filter-fractions.py --help
#+end_src

#+RESULTS:
#+begin_example
                                                                                
 Usage: filter-fractions.py [OPTIONS] FILTER_NAME CHANNEL                       
                                                                                
 Calculate fractional continuum/bands/lines contribution to a filter            
                                                                                
╭─ Arguments ──────────────────────────────────────────────────────────────────╮
│ *    filter_name      TEXT     [default: None] [required]                    │
│ *    channel          INTEGER  [default: None] [required]                    │
╰──────────────────────────────────────────────────────────────────────────────╯
╭─ Options ────────────────────────────────────────────────────────────────────╮
│ --data-path          PATH  [default: FilterMaps]                             │
│ --prefix             TEXT  [default: nostar]                                 │
│ --all-label          TEXT  [default: all]                                    │
│ --frac-labels        TEXT  [default: cont, bands, lines]                     │
│ --help                     Show this message and exit.                       │
╰──────────────────────────────────────────────────────────────────────────────╯

#+end_example

Apply the script to calculate the fractions

#+begin_src sh :dir data/jwst-miri-mrs :results verbatim
  for i in f770w,1 f770w,2 f1130w,2 f1280w,3 f1800w,3 f1800w,4; do
      IFS=',' read fn chan <<< "${i}"
      python ../../scripts/filter-fractions.py ${fn} ${chan}
  done
#+end_src

#+RESULTS:

*** Conclusions based on the contribution fractions
- Taking into account the average of bands 1 and 2 for f777w
  - Relative fractions:
    - Continuum: 0.6
    - Lines: 0.2
    - Bands: 0.2
- For F1130W we can distinguish between the core and halo of the knots
  - Core:
    - Continuum: 0.48
    - Lines: 0.02
    - Band: 0.5
  - Halo:
    ...
    - Lines: 0.05
    - Band: 0.25
- For F1280W we can distinguish between the core and halo of the knots
  - Core:
    - Continuum: 0.5
    - Lines: 0.45
    - Band: 0.05
...
*** Atomic continuum relative to H I lines
- PyNeb can report this in units of 1/Angstrom
#+begin_src python :results output verbatim
  ...
  # From 1 to 20 micron
  waves = np.arange(1, 20) * u.micron
  # Normalise to the H I 5-6 7.459858 line
  cont = C.get_continuum(tem=20000, den=1e2, He1_H=0.05, He2_H=0.0, 
                         wl = waves.to_value(u.Angstrom), HI_label="6_5")
  # Convert to per micron
  cont = (cont * u.Angstrom ** -1).to(u.micron ** -1)

  print(QTable({"Wavelength": waves, "Cont / HI 5-6": cont}))
#+end_src

#+RESULTS:
#+begin_example
Wavelength   Cont / HI 5-6   
  micron       1 / micron    
---------- ------------------
       1.0 139.85542870159745
       2.0  38.63481790801852
       3.0  17.81361582865647
       4.0 10.310569558716779
       5.0  6.771301100488464
       6.0  4.815740077158114
       7.0 3.6677093965041037
       8.0  2.854457047032616
       9.0  2.314712335257088
      10.0 1.8997589157038444
      11.0  1.602262775068541
      12.0 1.3616151209182779
      13.0  1.179699263708989
      14.0 1.0274353267912895
      15.0 0.9077615640997914
      16.0  0.805106916208342
      17.0 0.7219823897883121
      18.0 0.6493698448661216
      19.0 0.5891658014234394
#+end_example

- This should be compared with the line and continuum in Channel 1
- However, this is very noisy and is negative in places!
  - So we can only really get an upper limit on the diffuse nebular continuum
  - But we can measure the total continuum from the knots
- H I 5-6 7.46 micron line has peak of about 6 micron MJy/sr at knot A
  - So the predicted continuum is about 10 MJy/sr
- CONT 7.5 has peak of about 200 MJy/sy at knot A
  - So that atomic continuum is about 5%
    


**** Repeat for the 19 micron 7-8 line
#+begin_src python :results output verbatim
  import pyneb as pn
  import numpy as np
  from astropy import units as u
  ...
  # From 1 to 20 micron
  waves = np.arange(1, 20) * u.micron
  # Normalise to the H I 7-8 line
  cont = C.get_continuum(tem=20000, den=1e2, He1_H=0.05, He2_H=0.0, 
                         wl = waves.to_value(u.Angstrom), HI_label="8_7")
  # Convert to per micron
  cont = (cont * u.Angstrom ** -1).to(u.micron ** -1)

  print(QTable({"Wavelength": waves, "Cont / HI 7-8": cont}))
#+end_src

#+RESULTS:
#+begin_example
Wavelength   Cont / HI 7-8   
  micron       1 / micron    
---------- ------------------
       1.0  874.0964293849839
       2.0 241.46761192511573
       3.0 111.33509892910294
       4.0  64.44105974197986
       5.0   42.3206318780529
       6.0 30.098375482238207
       7.0 22.923183728150647
       8.0 17.840356543953853
       9.0 14.466952095356797
      10.0 11.873493223149028
      11.0  10.01414234417838
      12.0  8.510094505739238
      13.0  7.373120398181181
      14.0  6.421470792445558
      15.0  5.673509775623696
      16.0  5.031918226302137
      17.0   4.51238993617695
      18.0   4.05856153041326
      19.0  3.682286258896496
#+end_example
...
**** TODO Update [2023-11-23 Thu]
- Looking at the filter maps of the star cube, it is obvious that we need to restrict the radius of the PSF
  - At larger radii, you see constant levels or structure that has nothing to do with the PSF
- This explains why we seem to have oversubtracted the star in many cases
- It is possible that some of the structure might be scattered stellar light in the nebula
  - But I am not sure how plausible that is
  - Not very
